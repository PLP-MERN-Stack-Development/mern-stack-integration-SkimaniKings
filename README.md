...
Welcome to **SkimaniKings Blog** – a full-stack MERN (MongoDB, Express, React, Node.js) application where an admin can post blogs, and users can like and comment on each blog post. This project is designed to create a seamless and interactive blogging experience.
...
1. Clone this repository:
   ```bash
   git clone 'https://github.com/PLP-MERN-Stack-Development/mern-stack-integration-SkimaniKings.git'
   ```
